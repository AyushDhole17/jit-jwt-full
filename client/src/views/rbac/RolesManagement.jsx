            ...
            <CardContent sx={{ p: 3 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <Box>
                  ...
                  <Typography variant="h3" fontWeight={600}>{roles.length}</Typography>
                </Box>
            ...
            <CardContent sx={{ p: 3 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <Box>
                  ...
                  <Typography variant="h3" fontWeight={600}>{roles.filter((r) => r.isActive).length}</Typography>
                </Box>
            ...
            <CardContent sx={{ p: 3 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <Box>
                  ...
                  <Typography variant="h3" fontWeight={600}>{roles.filter((r) => r.isSystem).length}</Typography>
                </Box>
                  ...
                  <Stack spacing={2.5}>
                    ...
                    <Box>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1.5 }}>
                        ...
                        <Chip 
                          label={`${role.permissions?.length || 0} assigned`}
                          size="small"
                          color="primary"
                          variant="outlined"
                        />
