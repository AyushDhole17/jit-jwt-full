        ...
        <Dialog open={openRoleDialog} onClose={handleCloseRoleDialog} maxWidth="sm" fullWidth>
          ...
          <DialogContent>
            <Stack spacing={2} sx={{ mt: 2 }}>
              <Alert severity="info">Assigning a role will grant the user all permissions associated with that role.</Alert>
              <FormControl fullWidth>
          ...
          <DialogContent>
            <Stack spacing={2.5} sx={{ mt: 2 }}>
              ...
              <TextField
                ...
                helperText={
                  addForm.password && addForm.password.length < 6 ? 'Password must be at least 6 characters' : 'Minimum 6 characters'
                }
              />
              <TextField
                label="Mobile"
                ...
                helperText={
                  addForm.mobile && addForm.mobile.length > 0 && addForm.mobile.length < 10
                    ? `${addForm.mobile.length}/10 digits`
                    : addForm.mobile && !/^[0-9]{10}$/.test(addForm.mobile)
                      ? 'Must be 10 digits'
                      : 'Optional'
                }
              />
              ...
              <FormControl fullWidth>
                ...
                <Select value={addForm.roleId} onChange={(e) => setAddForm({ ...addForm, roleId: e.target.value })} label="Assign Role">
                  <MenuItem value="">
